...
public class CommandExtendAdd extends Command {

    public CommandExtendAdd() {
        super("extend add");
    ...
    public CommandResponse execute(Player player, Set<String> flags, Map<String, Object> parameters,
        ...
        commandMap.put(player, lastString + baseParameters.get(0));
        return new CommandResponse("&aCommand extension successfully added!");
