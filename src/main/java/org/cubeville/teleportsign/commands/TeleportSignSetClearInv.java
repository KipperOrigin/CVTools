...
public class TeleportSignSetClearInv extends Command {

    public TeleportSignSetClearInv() {
        super("set clearinv");
    ...
    public CommandResponse execute(Player player, Set<String> flags, Map<String, Object> parameters,
        ...
        sign.getSignProperties((TeleportSign.Team) baseParameters.get(1)).setClearsInv((boolean) baseParameters.get(2));
